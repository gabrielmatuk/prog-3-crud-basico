...
const createUsuario = async (req, res, next) => {
  try {
    ...
    //Determinei que os campos nome email e endereço são obrigatorios, caso não tenha vou ter um 400 e mensagem de erro, além de mostrar no console
    if (!usuario.nome || !usuario.email || !usuario.endereco) {
      res.status(400);
      res.send("Nome, Email e Endereço do aluno são obrigatórios!");
      throw new Error("Nome, Email e Endereço do aluno são obrigatórios!");
    }
